...
pygame.display.init()
pygame.font.init()
screen = pygame.display.set_mode((550, 550))#,  FULLSCREEN)
...
for y in range(4):
    for x in range(4):
        bg.blit(blank, ((x*133)+16, (y*133)+16))
overimg=pygame.Surface((550, 550))
